...
return true;}
function insertHtmlAtCaret(html){var targetSelector=(arguments.length>1)?arguments[1]:null;var sel,range;if(window.getSelection){sel=window.getSelection();console.log(11111111);console.log(sel);console.log(sel.anchorNode);console.log($(sel.anchorNode));console.log($(sel.anchorNode).parent());console.log($(sel.anchorNode).closest(targetSelector).length);console.log($(sel.anchorNode).closest('#hogehoge').length);if(targetSelector){if(!$(targetSelector).find(sel.anchorNode))return false;targetSelectorPrefix=targetSelector.slice(0,1);targetSelectorName=targetSelector.slice(1);if(targetSelectorPrefix=='.'){if(!$(sel.anchorNode).hasClass(targetSelectorName)||$(sel.anchorNode).closest(targetSelector)==0)return false;}else if(targetSelectorPrefix=='#'){if(!$(sel.anchorNode).attr('id')!=targetSelectorName||$(sel.anchorNode).closest(targetSelector)==0)return false;}}
