...
return true;}
function insertHtmlAtCaret(html){var targetSelector=(arguments.length>1)?arguments[1]:null;var sel,range;if(window.getSelection){sel=window.getSelection();console.log(sel.anchorNode);if(targetSelector){if(!$(targetSelector).find(sel.anchorNode))return false;targetSelectorPrefix=targetSelector.slice(0,1);targetSelectorName=targetSelector.slice(1);console.log(targetSelector);console.log($(sel.anchorNode).closest(targetSelector));}
