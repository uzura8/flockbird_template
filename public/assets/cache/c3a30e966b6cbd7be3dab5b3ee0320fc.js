...
return true;}
function checkCursorOnTarget(selectedNode,targetSelector){if($(selectedNode).closest(targetSelector).length)return true;targetSelectorPrefix=targetSelector.slice(0,1);targetSelectorName=targetSelector.slice(1);if(targetSelectorPrefix=='.'){if($(selectedNode).hasClass(targetSelectorName))return true;}else if(targetSelectorPrefix=='#'){if($(selectedNode).attr('id')==targetSelectorName)return true;}
return false;}
