...
return true;}
function insertHtmlAtCaret(html){var targetSelector=(arguments.length>1)?arguments[1]:null;var sel,range;if(window.getSelection){sel=window.getSelection();console.log(sel);if(targetSelector){targetSelectorPrefix=targetSelector.slice(0,1);targetSelectorName=targetSelector.slice(1);console.log(targetSelectorPrefix);console.log(targetSelectorName);console.log(sel.anchorNode);console.log(11111);if(targetSelectorPrefix=='.'){console.log(2222);}else if(targetSelectorPrefix=='#'){if(!$(sel.anchorNode).attr('id')!=targetSelectorName)return false;}}
